...
namespace EggFarmSystem.Client.Core
{
    public static class CommonMessages
    {
        ...
        public static string DeleteHenCommand = "DeleteHen";
        public static string HenSaved = "HenSaved";
        ...
        public static string LoadHouse = "LoadHouse";
        public static string RefreshHouseList = "RefreshHouseList";
        ...
        public static string EditConsumableEntry = "EditConsumableEntry";
        public static string DeleteConsumable = "DeleteConsumable";
        public static string SaveConsumableSuccess = "SaveConsumableSuccess";
        public static string SaveConsumableFailed = "SaveConsumableFailed";
        public static string LoadConsumable = "LoadConsumable";
        public static string RefreshConsumableList = "RefreshConsumableList";
        public static string DeleteConsumableSuccess ="DeleteConsumableSuccess";
        public static string DeleteConsumableFailed = "DeleteConsumableFailed";

        public static string NewUsageView = "NewUsageView";
        public static string NewUsageEntry = "NewUsageEntry";
        public static string EditUsageView = "EditUsageView";
        public static string EditUsageEntry = "EditUsageEntry";
        public static string DeleteUsage = "DeleteUsage";
        public static string SaveUsageSuccess = "SaveUsageSuccess";
        public static string SaveUsageFailed = "SaveUsageFailed";
        public static string LoadUsage = "LoadUsage";
        public static string RefreshUsageList = "RefreshUsageList";
        public static string DeleteUsageSuccess = "DeleteUsageSuccess";
        public static string DeleteUsageFailed = "DeleteUsageFailed";

        public static string NewEmployeeCostView = "NewEmployeeCostView";
        public static string NewEmployeeCostEntry = "NewUsageEntry";
        public static string EditEmployeeCostView = "EditEmployeeCostView";
        public static string EditEmployeeCostEntry = "EditEmployeeCostEntry";
        public static string DeleteEmployeeCost = "DeleteEmployeeCost";
        public static string SaveEmployeeCostSuccess = "SaveEmployeeCostSuccess";
        public static string SaveEmployeeCostFailed = "SaveEmployeeCostFailed";
        public static string LoadEmployeeCost = "LoadEmployeeCost";
